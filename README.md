...
+ [`props`](props) contains the proportions of subgroups at different time after diagonsis for [`4_time_to_diagnosis.ipynb`](4_time_to_diagnosis.ipynb)
...
+ [`DE_results`](DE_results) contains the results of the differential analysis based on the SNF results.
...
+ [`2_snf_python_E:CI.ipynb`](2_SNF_LMCI.ipynb) contains the script to determine the best number of SNF clusters on LMCI data.
